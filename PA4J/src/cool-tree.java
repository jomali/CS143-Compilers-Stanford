...
class programc extends Program {
	 ...
	 * errors. Part (2) can be done in a second stage when you want to test
...
class assign extends Expression {
	...
	// TODO - Verificar que la asignación se realiza entre objetos del mismo
	// tipo

	@Override
	public void semant(ClassTable classTable, class_c c) { }
...
class dispatch extends Expression {
	...
	// TODO - Verificar que el número de parámetros en los métodos coincida
...
class cond extends Expression {
	...
	// TODO - Verificar que la condición sea un booleano
...
class block extends Expression {
	...
	// TODO - Analizar semánticamente cada expresión contenida en el bloque
...
class let extends Expression {
	...
	/*
	 * Verificar corrección semántica del cuerpo del "let" y considerar el
	 * alcance (scope) de la expresión.
	 */
	@Override
	public void semant(ClassTable classTable, class_c c) {
		if (Flags.semant_debug) {
...
class plus extends Expression {
	...
	/*
	 * Verifica que ambos operandos se corresponden con un números enteros.
	 */
	@Override
	public void semant(ClassTable classTable, class_c c) {
		if (Flags.semant_debug) {
		...
		e1.semant(classTable, c);
		e2.semant(classTable, c);
...
class neg extends Expression {
	...
	/*
	 * Verifica que el operando se corresponde con un número entero.
	 */
	@Override
	public void semant(ClassTable classTable, class_c c) {
		if (Flags.semant_debug) {
		...
		if (e1.get_type().equals(TreeConstants.Int)) {
			...
			// First, an error message should be printed with the line number
			// and a description of what went wrong. It is relatively easy to
			// give informative error messages in the semantic analysis phase,
			// because it is generally obvious what the error is. We expect you
			// to give informative error messages. Second, the semantic
			// analyzer should attempt to recover and continue. We do expect
			// your semantic analyzer to recover, but we do not expect it to
			// avoid cascading errors. A simple recovery mechanism is to assign
			// the type Object to any expression that cannot otherwise be given
			// a type
			classTable.semantError(c.getFilename(), c)
...
class lt extends Expression {
	...
	// TODO - Verificar que los operandos son números enteros. Debe retornarse
	// un valor booleano
...
class eq extends Expression {
	...
	// TODO - Verificar que si el primer tipo es de una de las clases básicas,
...
class leq extends Expression {
	...
	// TODO - Verificar que los operandos son números enteros
	@Override
	public void semant(ClassTable classTable, class_c c) { }
...
class int_const extends Expression {
	...
	public void semant(ClassTable classTable, class_c c) {
		if (Flags.semant_debug) {
			System.out.println(" -- Integer: " + token.getString() + ", " +
				getLineNumber());
		}
		set_type(TreeConstants.Int);
	}
...
class new_ extends Expression {
	...
	// TODO - Verificar que el operador se utiliza sobre una clase existente
	@Override
	public void semant(ClassTable classTable, class_c c) { }
...
class isvoid extends Expression {
	...
	// TODO - Realizar análisis semántico sobre la expresión. Debe retornar
	// un valor booleano
	@Override
	public void semant(ClassTable classTable, class_c c) { }
...
class object extends Expression {
	...
	// TODO - Verificar que el objeto esté declarado
	@Override
	public void semant(ClassTable classTable, class_c c) { }
